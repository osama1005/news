...
import 'package:news/modules/home/view_model/articales_view_model.dart';
...
class _ArticlesListViewState extends State<ArticlesListView> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) =>
          ArticalesViewModel()
            ..getAllSources(widget.selectedCategory.categoryId).then((value) {
              Provider.of(context, listen: false).getAllArticles(
                Provider.of<ArticalesViewModel>(
                  context,
                  listen: false,
                ).sourceList[0].sourceId,
              );
            }),
      child: Column(
        spacing: 10,
